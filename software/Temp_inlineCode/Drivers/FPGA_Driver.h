...
#define FPGA_CURRENT_TRIP_LEVEL_REGISTER			13

#define FPGA_REGISTERS_PER_CONTROLLER				16



#define STATUS_FLAGS_TOGGLE_BIT								0x0001  // 1    bit 0
#define STATUS_FLAGS_MOTOR_DEENERGISED						0x0002  // 2    bit 1
#define STATUS_FLAGS_MOTOR_ENERGISED						0x0004  // 4    bit 2
#define	STATUS_FLAGS_COAST_BIT								0x0008  // 8    bit 3
#define STATUS_FLAGS_FAULT_PRESENT							0x0010  // 16   bit 4
#define STATUS_FLAGS_FPGA_FAULT_RESET						0x0020	// 32   bit 5
#define STATUS_HARDWARE_DAC_OPTION							0x0040	// 64   bit 6
#define STATUS_INTEGRATOR_ENABLE_FLAG						0x0080	// 128  bit 7
#define STATUS_ENABLE_MEMORY_CAPTURE_FLAG					0x0100	// 256  bit 8
#define	STATUS_HARDWARE_MUX_0								0x0200  // 512  bit 9
#define	STATUS_HARDWARE_MUX_1								0x0400  // 1024 bit 10
#define	STATUS_SEND_DAC_ENABLE_MESSAGE						0x0800  // 2048 bit 11
