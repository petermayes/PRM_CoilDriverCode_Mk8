...
static float Tempfloat = 1.1f;
	...
	Registers.CurrCTRL_CurrentDemandAfterRamp_V.DataType = SINGLE;
	Registers.CurrCTRL_CurrentLoopErrorTerm.DataType = SINGLE;
	Registers.CurrCTRL_P_Term_V.DataType = SINGLE;
	Registers.CurrCTRL_I_Term_V.DataType = SINGLE;
	Registers.CurrCTRL_OutputDemand.DataType = SINGLE;
	Registers.CurrCTRL_I_Trip_Readback.DataType = SINGLE;
