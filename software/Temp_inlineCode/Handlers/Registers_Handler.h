...
typedef struct DataDictionary
{
	...
	DataDictionaryEntry			CurrCTRL_I_Term_V;					// 73
	DataDictionaryEntry			CurrCTRL_OutputDemand;				// 74
	DataDictionaryEntry			CurrCTRL_I_Trip_Readback;			// 75
	...
	DataDictionaryEntry			CurrentLoop_P_Gain;					// 80
	DataDictionaryEntry			CurrentLoop_I_Gain;					// 81
	DataDictionaryEntry			CurrentLoop_RampRate;				// 82
	DataDictionaryEntry			CurrentLoop_VoltageLimit_V;			// 83
	DataDictionaryEntry			CurrentScalingFactor_bit_mA;		// 84
	DataDictionaryEntry			CurrentScalingFactor_mA_bit;		// 85
	DataDictionaryEntry			VoltageScalingFactor_mV_bit;		// 86
	DataDictionaryEntry			VoltageScalingFactor_bit_mV;		// 87
	DataDictionaryEntry			OutputStageGain;					// 88
	DataDictionaryEntry			PositiveCurrentTripValue_mA;		// 89
	DataDictionaryEntry			Debug_0;							// 90
	DataDictionaryEntry			Debug_1;							// 91
	DataDictionaryEntry			Debug_2;							// 92
	DataDictionaryEntry			Debug_3;							// 93
	DataDictionaryEntry			Debug_4;							// 94
	DataDictionaryEntry			Debug_5;							// 95
	DataDictionaryEntry			Debug_6;							// 96
	DataDictionaryEntry			Debug_7;							// 97
	DataDictionaryEntry			Debug_8;							// 98
	DataDictionaryEntry			Debug_9;							// 99
	DataDictionaryEntry			Debug_10;							// 100
...
extern void ClearDriveStateRequest(void);
