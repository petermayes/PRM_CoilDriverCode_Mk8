...
# Memory: CurrCTRL_SYS_CurrCTRL_Register_RAM
MEM_0 := Mk8_InlineController_CPU_CurrCTRL_SYS_CurrCTRL_Register_RAM
$(MEM_0)_NAME := CurrCTRL_SYS_CurrCTRL_Register_RAM
...
$(MEM_0)_END := 0x020003ff
$(MEM_0)_SPAN := 0x00000400
$(MEM_0)_HIERARCHICAL_PATH := CurrCTRL_SYS.CurrCTRL_Register_RAM
$(MEM_0)_WIDTH := 32
$(MEM_0)_HEX_DATA_WIDTH := 32
$(MEM_0)_ENDIANNESS := --little-endian-mem
$(MEM_0)_CREATE_LANES := 0

.PHONY: CurrCTRL_SYS_CurrCTRL_Register_RAM
CurrCTRL_SYS_CurrCTRL_Register_RAM: check_elf_exists $(MEM_INIT_DIR)/$(MEM_0).hex $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym

# Memory: Data_Memory
MEM_1 := Mk8_InlineController_CPU_Data_Memory
$(MEM_1)_NAME := Data_Memory
...
$(MEM_1)_START := 0x00018000
$(MEM_1)_END := 0x0001a3ff
$(MEM_1)_SPAN := 0x00002400
$(MEM_1)_HIERARCHICAL_PATH := Data_Memory
$(MEM_1)_WIDTH := 32
...
.PHONY: Data_Memory
Data_Memory: check_elf_exists $(MEM_INIT_DIR)/$(MEM_1).hex $(HDL_SIM_DIR)/$(MEM_1).dat $(HDL_SIM_DIR)/$(MEM_1).sym

# Memory: Parameter_SYS_Parameter_RX_RAM
MEM_2 := Mk8_InlineController_CPU_Parameter_SYS_Parameter_RX_RAM
$(MEM_2)_NAME := Parameter_SYS_Parameter_RX_RAM
...
$(MEM_2)_START := 0x00006000
$(MEM_2)_END := 0x00007003
$(MEM_2)_SPAN := 0x00001004
$(MEM_2)_HIERARCHICAL_PATH := Parameter_SYS.Parameter_RX_RAM
$(MEM_2)_WIDTH := 32
$(MEM_2)_HEX_DATA_WIDTH := 32
$(MEM_2)_ENDIANNESS := --little-endian-mem
$(MEM_2)_CREATE_LANES := 0

.PHONY: Parameter_SYS_Parameter_RX_RAM
Parameter_SYS_Parameter_RX_RAM: check_elf_exists $(MEM_INIT_DIR)/$(MEM_2).hex $(HDL_SIM_DIR)/$(MEM_2).dat $(HDL_SIM_DIR)/$(MEM_2).sym

# Memory: Parameter_SYS_Parameter_TX_RAM
MEM_3 := Mk8_InlineController_CPU_Parameter_SYS_Parameter_TX_RAM
$(MEM_3)_NAME := Parameter_SYS_Parameter_TX_RAM
...
$(MEM_3)_START := 0x0101c000
$(MEM_3)_END := 0x0101d003
$(MEM_3)_SPAN := 0x00001004
$(MEM_3)_HIERARCHICAL_PATH := Parameter_SYS.Parameter_TX_RAM
$(MEM_3)_WIDTH := 32
$(MEM_3)_HEX_DATA_WIDTH := 32
$(MEM_3)_ENDIANNESS := --little-endian-mem
$(MEM_3)_CREATE_LANES := 0

.PHONY: Parameter_SYS_Parameter_TX_RAM
Parameter_SYS_Parameter_TX_RAM: check_elf_exists $(MEM_INIT_DIR)/$(MEM_3).hex $(HDL_SIM_DIR)/$(MEM_3).dat $(HDL_SIM_DIR)/$(MEM_3).sym

# Memory: Program_Memory
MEM_4 := Mk8_InlineController_CPU_Program_Memory
$(MEM_4)_NAME := Program_Memory
...
$(MEM_4)_START := 0x00010000
$(MEM_4)_END := 0x00017fff
$(MEM_4)_SPAN := 0x00008000
$(MEM_4)_HIERARCHICAL_PATH := Program_Memory
$(MEM_4)_WIDTH := 32
$(MEM_4)_HEX_DATA_WIDTH := 32
$(MEM_4)_ENDIANNESS := --little-endian-mem
$(MEM_4)_CREATE_LANES := 0

.PHONY: Program_Memory
Program_Memory: check_elf_exists $(MEM_INIT_DIR)/$(MEM_4).hex $(HDL_SIM_DIR)/$(MEM_4).dat $(HDL_SIM_DIR)/$(MEM_4).sym

# Memory: USB_Data_SYS_USB_RX_RAM
MEM_5 := Mk8_InlineController_CPU_USB_Data_SYS_USB_RX_RAM
$(MEM_5)_NAME := USB_Data_SYS_USB_RX_RAM
...
$(MEM_5)_START := 0x00004000
$(MEM_5)_END := 0x00005003
$(MEM_5)_SPAN := 0x00001004
$(MEM_5)_HIERARCHICAL_PATH := USB_Data_SYS.USB_RX_RAM
$(MEM_5)_WIDTH := 32
$(MEM_5)_HEX_DATA_WIDTH := 32
$(MEM_5)_ENDIANNESS := --little-endian-mem
$(MEM_5)_CREATE_LANES := 0

.PHONY: USB_Data_SYS_USB_RX_RAM
USB_Data_SYS_USB_RX_RAM: check_elf_exists $(MEM_INIT_DIR)/$(MEM_5).hex $(HDL_SIM_DIR)/$(MEM_5).dat $(HDL_SIM_DIR)/$(MEM_5).sym
