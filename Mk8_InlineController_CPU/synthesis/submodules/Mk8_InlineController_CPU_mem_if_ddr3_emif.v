// Mk8_InlineController_CPU_mem_if_ddr3_emif.v
...
`timescale 1 ps / 1 ps
module Mk8_InlineController_CPU_mem_if_ddr3_emif (
	...
	Mk8_InlineController_CPU_mem_if_ddr3_emif_pll0 pll0 (
	...
	Mk8_InlineController_CPU_mem_if_ddr3_emif_p0 p0 (
		.global_reset_n              (global_reset_n),                     //        global_reset.reset_n
	...
	Mk8_InlineController_CPU_mem_if_ddr3_emif_s0 s0 (
		.avl_clk                     (p0_avl_clk_clk),                     //          avl_clk.clk
		.avl_reset_n                 (p0_avl_reset_reset),                 //        avl_reset.reset_n
		.phasecounterselect          (s0_pll_reconfig_phasecounterselect), //     pll_reconfig.phasecounterselect
		.phasestep                   (s0_pll_reconfig_phasestep),          //                 .phasestep
	...
	Mk8_InlineController_CPU_mem_if_ddr3_emif_c0 c0 (
		.afi_reset_n         (afi_reset_n),                //    afi_reset.reset_n
		.afi_clk             (afi_clk),                    //      afi_clk.clk
		.afi_half_clk        (afi_half_clk),               // afi_half_clk.clk
